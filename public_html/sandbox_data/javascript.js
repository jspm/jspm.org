import { a as dew$1 } from './chunk-97c58f9e.js';
...
function dew() {
  ...
  (function (mod) {
    if (typeof exports == "object" && true) // CommonJS
      mod(dew$1());else if (typeof define == "function" && define.amd) // AMD
    ...
    CodeMirror.defineMode("javascript", function (config, parserConfig) {
      ...
      function JSLexical(indented, column, type, align, prev, info) {
        (this || _global).indented = indented;
        (this || _global).column = column;
        (this || _global).type = type;
        (this || _global).prev = prev;
        (this || _global).info = info;
        if (align != null) (this || _global).align = align;
      }
      ...
      function Context(prev, vars, block) {
        (this || _global).prev = prev;
        (this || _global).vars = vars;
        (this || _global).block = block;
      }
